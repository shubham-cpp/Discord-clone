    ...
    return(
        <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
            <div className="group flex gap-x-2 items-start w-full">
                <div className="cursor-pointer hover:drop-shadow-md tansition">
                ...
                <div className="flex flex-col w-full">
                    <div className="flex items-center gap-x-2">
                        <div className="flex items-center">
                            <p className="font-semibold text-sm hover:underline curor-pointer">
                                {member.profile.name}
                            </p>
                    ...
                    {isImage && (
                        ...
                        >
                            <Image alt={content} src={fileUrl} fill className="object-cover"/>
                        </a>
                    )}
                    {isPDF && (
                        <div className="relative flex items-center p-2 mt-2 rouded-md bg-background/10">
                        <FileIcon className="h-10 w-10 fill-indigo-200 strok-indigo-400" />
                            <a href={fileUrl || undefined}
                                target="_blank"
                                rel="noopener noreferrer"
                        ...
                        <Form {...form}>
                            <form
                                ...
                                onSubmit={form.handleSubmit(onSubmit)}>
                                    ...
                                    />
                                    <Button size="sm" className="" variant="primary" disabled={isLoading}>
                                        Save
                                    </Button>
                            </form>
